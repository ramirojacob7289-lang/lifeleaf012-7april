...
_Hasync.push(['Histats.start', '1,5018968,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?5018968&101" alt="free page hit counter" border="0"></a></noscript>
<!-- Histats.com  END  -->
        <meta charset="utf-8">
        <title>Freshness HTML5 Template</title>
        ...
        <div class="row">
          <div class="first-section" id="our-work">
            <div class="col-md-4 col-sm-12">
              <h2>Your Dream</h2>
              <span>Let us bring it into reality</span>
              <p>You can use this layout for any small and simple website. Feel free to modify this template for your needs. 
              	<br><br><strong class="blue">template</strong><strong class="green">mo</strong>.com provides free HTML5 templates to apply for personal or commercial websites.</p>
              <img class="first-icon" src="img/first-icon.png" alt="">
            </div>
            <div class="col-md-4 col-sm-12">
              <h4>From <em>start</em><br><br> to the <em>end</em></h4>
              <img class="second-icon" src="img/second-icon.png" alt="">
            </div> 
          </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6 col-sm-12">
                    <p class="copyright">Copyright &copy; 2084 <a href="#">Company Name</a></p>
                </div>
                <div class="col-md-6 col-sm-6 col-sm-12">
                    <ul class="social">
